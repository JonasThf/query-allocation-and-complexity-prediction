...
empty_t5_xl_answers_df = train_df.copy()

print("Loading Flan-T5 model...")
model_path_t5_xl = "flan-t5-xl-model"
...
t5_output_column = 'r_t5_xl'
t5_time_column = 'rt_t5_xl'
max_new_tokens = 5000
start_index = 0
end_index = 100

print("Running on ", device)
filled_t5_xl_answers_df = process_single_queries_with_timing(t5_model, t5_tokenizer, empty_t5_xl_answers_df, start_index, end_index, t5_output_column, t5_time_column, max_new_tokens, device)

# Output file path
output_file_path = 'mix-instruct/test.json'

# Write the updated DataFrame to the output file
print("Writing the final output to file...")
filled_t5_xl_answers_df.to_json(output_file_path, orient='records', lines=True)
